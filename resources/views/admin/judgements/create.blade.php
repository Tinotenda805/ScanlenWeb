...
<div class="container-fluid px-4 py-4">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3">Upload Judgement</h1>
    ...
    <form action="{{ route('admin.judgements.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Brief summary of the judgement</small>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   name="tags" 
                                   value="{{ old('tags') }}"
                                   placeholder="e.g., criminal law, civil procedure, contract">
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="bi bi-upload"></i> Upload Judgement
                        </button>
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header">
                        <h5 class="mb-0">Document File <span class="text-danger">*</span></h5>
                    </div>
                    <div class="card-body">
                        <input type="file" 
