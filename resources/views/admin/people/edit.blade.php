                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('bio') is-invalid @enderror" 
                                      id="bio" 
                                      name="bio" 
                                      rows="4">{{ old('bio', $person->bio) }}</textarea>
                            @error('bio')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input @error('type') is-invalid @enderror" 
                                   ...
                                   id="typePartner" 
                                   value="partner" 
                                   {{ old('type', $person->type) === 'partner' ? 'checked' : '' }}
                                   required>
                        ...
                        <div class="form-check">
                            <input class="form-check-input @error('type') is-invalid @enderror" 
                                   ...
                                   id="typeAssociate" 
                                   value="associate" 
                                   {{ old('type', $person->type) === 'associate' ? 'checked' : '' }}
                                   required>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <input type="file" 
                               ...
                               name="avatar" 
                               accept="image/*">
                        <small class="text-muted d-block mt-2">Leave empty to keep current photo</small>
                        @error('avatar')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
