...
<section class="py-5">
    <div class="container">
        <h1 class="page-heading">Our History</h1>
        <p class="intro-text mb-3">
            Pioneering Legal Excellence Since 1894.
        </p>
        
        <div class="culture">
            <div class="row align-items-start">
                <div class="culture-image col">
                    <img src="{{asset('images/law.jpg')}}" class="img-fluid rounded" width="100%" height="50%" alt="">
                </div>
                <div class="culture-info col">
                    <h4><u>Our History and Culture</u></h4>
...
<section class="partnership bg-body-secondary py-5 ">
    <div class="container">
        <h4><u>A New Partnership Is Born</u></h4>
        <div class="clearfix">
