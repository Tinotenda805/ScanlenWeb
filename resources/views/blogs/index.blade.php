...
@section('content')
@include('layouts.page-header', ['title' => 'Blog', 'breadcrumb' => 'Blog'])
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm hover-lift">
                    ...
                    @else
                    <div class="bg-gradient bg-success text-white d-flex align-items-center justify-content-center" style="height: 220px;">
                        <i class="bi bi-journal-text fs-1"></i>
                    </div>
                    @endif
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2">
                            <span class="badge bg-success me-2">{{ $featured->category->name }}</span>
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            ...
                            <a href="{{ route('blogs.show', $featured->slug) }}" class="btn btn-sm btn-outline-success">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body h-100 d-flex flex-column">
                                        ...
                                        <div class="mt-auto d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="{{ route('blogs.show', $blog->slug) }}" class="btn btn-success">Read More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a href="{{ route('blogs.index', ['tag' => $tag->slug]) }}" 
                                   class="badge bg-success text-decoration-none">#{{ $tag->name }}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
