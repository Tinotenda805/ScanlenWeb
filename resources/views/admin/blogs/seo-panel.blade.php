<!-- SEO & Readability Analysis Panel -->
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                      ...
                      rows="3" 
                      maxlength="160"
                      placeholder="Brief description for search engines (120-160 characters)">{{ old('meta_description', $blog->meta_description ?? '') }}</textarea>
        ...
        @if(isset($blog) && $blog->seo_score > 0)
        <div class="alert alert-info">
            <div class="row text-center">
                <div class="col-6">
                    <strong>SEO</strong>
                    <div class="mt-1">
                        <span class="badge bg-{{ $blog->getSeoStatusColor() }} fs-6">
                            {{ $blog->seo_score }}%
                        </span>
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <div class="mt-1">
                        <span class="badge bg-{{ $blog->getReadabilityStatusColor() }} fs-6">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function analyzeContent() {
        ...
        const data = {
            ...
            has_featured_image: document.getElementById('featured_image')?.files.length > 0 || {{ isset($blog) && $blog->featured_image ? 'true' : 'false' }},
            _token: document.querySelector('meta[name="csrf-token"]')?.content
        };

        fetch('{{ route("admin.blogs.analyze") }}', {
            method: 'POST',
            headers: {
