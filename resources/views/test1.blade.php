                ...
                <div class="carousel-track">
                    ...
                    <div class="logo-container p-2">
                        <a href="https://chambers.com/" target="_blank" class="text-decoration-none">
                            <img src="{{asset('images/champers.jpg')}}" class="membership-logo rounded p-2" alt="Champers">
                        </a>
                    </div>
                    <div class="logo-container p-2">
                        <a href="https://lexafrica.com/" target="_blank" class="text-decoration-none">
                            <img src="{{asset('images/lexafrica.png')}}" class="membership-logo rounded p-2" alt="Lex Africa">
                        </a>
                    </div>
                    <div class="logo-container p-2">
                        <a href="https://www.meritas.org/" target="_blank" class="text-decoration-none">
                            <img src="{{asset('images/meritas_logo.png')}}" class="membership-logo rounded p-2" alt="Maritas">
                        </a>
                    </div>
