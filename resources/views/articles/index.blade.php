                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-2">
                                   <a href="{{route('articles.index')}}" class="text-decoration-none text-dark d-flex justify-content-between align-items-center">
                                        <span>ALL</span>
                                        <span class="badge bg-light text-dark">{{ $articles->count() }}</span>
                                    </a> 
                                </li>
